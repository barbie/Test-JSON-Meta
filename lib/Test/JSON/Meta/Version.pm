package Test::JSON::Meta::Version;
...
Test::JSON::Meta::Version - Validation of META.json specification elements.
...
This module is meant to be used together with L<Test::JSON::Meta>, however
the code is self contained enough that you can access it directly.

=head1 ABSTRACT

Validation of META.json data against the META.yml specification elements.
